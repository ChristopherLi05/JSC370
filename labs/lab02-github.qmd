...
```sh
git clone https://github.com/ChristopherLi05/JSC370.git
cd JSC370
```
...
```sh
https://github.com/ChristopherLi05/JSC370
```
...
```sh
commit: acc67b5a9b1560a9cb8dad27d6d4e43f3419af2b
Author: ChristopherLi05
Date: Wed Jan 14 13:15:23 2026 -0500
```
