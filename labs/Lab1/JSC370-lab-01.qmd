...
[>] Checking Python 3 installation....OK
      Version: 3.14.0
      Path: C:/Users/a/IdeaProjects/JSC370-2026/.venv/Scripts/python.exe
      Jupyter: 5.9.1
      Kernels: python3

(\) Checking Jupyter engine render....C:\Users\a\AppData\Local\Programs\Quarto\share\jupyter\jupyter.py:28: DeprecationWarning: 'asyncio.WindowsSelectorEventLoopPolicy' is deprecated and slated for removal in Python 3.16
  asyncio.set_event_loop_policy(asyncio.WindowsSelectorEventLoopPolicy())
C:\Users\a\AppData\Local\Programs\Quarto\share\jupyter\jupyter.py:28: DeprecationWarning: 'asyncio.set_event_loop_policy' is deprecated and slated for removal in Python 3.16
  asyncio.set_event_loop_policy(asyncio.WindowsSelectorEventLoopPolicy())
...
(
    ...
    + labs(title="Penguin bill measurements — Christopher Li")  
    + theme_minimal()
)
```
